...
namespace BookClubApi.Migrations
{
    ...
    [Migration("20260505141001_CreateAnnouncementThreadTable")]
    partial class CreateAnnouncementThreadTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookClubApi.Models.AnnouncementThread", b =>
                {
                    b.Property<int>("AnnouncementThreadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("announcement_thread_id");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("AnnouncementThreadId"));

                    b.Property<int>("ClubId")
                        .HasColumnType("int")
                        .HasColumnName("club_id");

                    b.Property<int?>("ParentAnnouncementThreadId")
                        .HasColumnType("int")
                        .HasColumnName("parent_announcement_thread_id");
                    ...
                    b.HasKey("AnnouncementThreadId")
                        .HasName("PRIMARY");

                    b.HasIndex("ParentAnnouncementThreadId")
                        .HasDatabaseName("idx_parent_announcement_thread");

                    b.HasIndex("ParentAnnouncementThreadId", "TimePosted")
                        .HasDatabaseName("idx_parentBatch_announcement_thread");

                    b.HasIndex("ParentAnnouncementThreadId", "TimePosted", "AnnouncementThreadId")
                        .IsDescending(false, true, true)
                        .HasDatabaseName("idx_announcement_thread_tree");

                    b.HasIndex("ClubId", "ParentAnnouncementThreadId", "TimePosted", "AnnouncementThreadId")
                        .IsDescending(false, false, true, true)
                        .HasDatabaseName("idx_root_announcement_threads");

                    b.HasIndex(new[] { "ClubId" }, "book_id4");

                    b.HasIndex(new[] { "ParentAnnouncementThreadId" }, "parent_thread_id");

                    b.HasIndex(new[] { "UserId" }, "user_id3");

                    b.ToTable("announcement_thread", "BookClub");
                });
            ...
            modelBuilder.Entity("BookClubApi.Models.Notification", b =>
                {
                    ...
                    b.ToTable("notification", "BookClub");
                });
            ...
            modelBuilder.Entity("BookClubApi.Models.ProgressType", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("ProgresstypeId"));
            ...
            modelBuilder.Entity("BookClubApi.Models.Thread", b =>
                {
                    ...
                    b.HasIndex("ParentThreadId", "TimePosted", "ThreadId")
                        .IsDescending(false, true, true)
                    ...
                    b.HasIndex(new[] { "BookId", "ClubId" }, "book_id4")
                        .HasDatabaseName("book_id41");

                    b.HasIndex(new[] { "ParentThreadId" }, "parent_thread_id")
                        .HasDatabaseName("parent_thread_id1");

                    b.HasIndex(new[] { "UserId" }, "user_id3")
                        .HasDatabaseName("user_id31");
            ...
            modelBuilder.Entity("BookClubApi.Models.AnnouncementThread", b =>
                {
                    ...
                    b.HasOne("BookClubApi.Models.AnnouncementThread", "ParentThread")
                        .WithMany("InverseParentThread")
                        .HasForeignKey("ParentAnnouncementThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("announcement_thread_ibfk_3");

                    b.HasOne("BookClubApi.Models.User", "User")
                        .WithMany("AnnouncementThreads")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("BookClubApi.Models.User", b =>
                {
                    b.Navigation("AnnouncementThreads");
