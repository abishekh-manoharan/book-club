...
function NavHeaderLoggedInMobile({setMobileMenuOpen}: { setMobileMenuOpen: React.Dispatch<React.SetStateAction<boolean>>}) {
...
export default NavHeaderLoggedInMobile;